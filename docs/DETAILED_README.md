...
This file continues the submodule [`README.md`](../README.md): **Features** through the **database schema diagram** (formerly inline in the README). For architecture, security overview, and moderation summary, start at the main README.
