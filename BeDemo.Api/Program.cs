...
// isTestingEnv is also used elsewhere, so it stays here; the rate-limiter setup is extracted to
// AddManyFacesRateLimiting (Phase 3 Program.cs modularisation).
var isTestingEnv = builder.Environment.IsEnvironment("Testing");
builder.Services.AddManyFacesRateLimiting(builder.Configuration, isTestingEnv);
