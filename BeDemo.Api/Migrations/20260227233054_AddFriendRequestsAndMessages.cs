...
{
	/// <inheritdoc />
	public partial class AddFriendRequestsAndMessages : Migration
	{
		/// <inheritdoc />
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					FriendId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
					CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
				},
				constraints: table =>
				{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					IsMessageRequest = table.Column<bool>(type: "boolean", nullable: false),
					MessageRequestStatus = table.Column<int>(type: "integer", nullable: true)
				},
				constraints: table =>
				{
