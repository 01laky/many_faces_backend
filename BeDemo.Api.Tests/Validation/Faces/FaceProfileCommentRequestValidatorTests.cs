...
public sealed class FaceProfileCommentRequestValidatorTests
{
	private readonly FaceProfileCommentRequestValidator _sut = new();

	[Fact]
	public void Valid_minimal_instance_has_no_errors()
	{
		var model = new FaceProfileCommentDto();
