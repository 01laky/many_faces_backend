...
public sealed class CreatePageComponentRequestValidatorTests
{
	private readonly CreatePageComponentRequestValidator _sut = new();

	[Fact]
	public void Valid_minimal_instance_has_no_errors()
	{
		var model = new CreatePageComponentDto();
