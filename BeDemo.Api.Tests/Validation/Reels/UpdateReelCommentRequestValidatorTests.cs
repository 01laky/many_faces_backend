...
public sealed class UpdateReelCommentRequestValidatorTests
{
	private readonly UpdateReelCommentRequestValidator _sut = new();

	[Fact]
	public void Valid_minimal_instance_has_no_errors()
	{
		var model = new UpdateReelCommentDto();
