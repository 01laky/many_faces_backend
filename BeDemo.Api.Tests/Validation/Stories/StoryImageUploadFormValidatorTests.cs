...
public sealed class StoryImageUploadFormValidatorTests
{
	private readonly StoryImageUploadFormValidator _sut = new();

	[Fact]
	public void Valid_minimal_instance_has_no_errors()
	{
		var model = new BeDemo.Api.Models.DTOs.StoryImageUploadForm();
