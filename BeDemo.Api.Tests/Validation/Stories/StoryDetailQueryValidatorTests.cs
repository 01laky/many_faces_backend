...
public sealed class StoryDetailQueryValidatorTests
{
	private readonly StoryDetailQueryValidator _sut = new();

	[Fact]
	public void Valid_minimal_instance_has_no_errors()
	{
		var model = new BeDemo.Api.Models.Requests.Stories.StoryDetailQuery();
